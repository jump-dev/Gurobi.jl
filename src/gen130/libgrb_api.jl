...
function GRBloadenvinternal(envP, logfilename, major, minor, tech)
    ccall((:GRBloadenvinternal, libgurobi), Cint, (Ptr{Ptr{GRBenv}}, Ptr{Cchar}, Cint, Cint, Cint), envP, logfilename, major, minor, tech)
end

function GRBemptyenvinternal(envP, major, minor, tech)
    ccall((:GRBemptyenvinternal, libgurobi), Cint, (Ptr{Ptr{GRBenv}}, Cint, Cint, Cint), envP, major, minor, tech)
end
...
function GRBsetcallbackfuncadv(model, cb, usrdata, wheres)
    ccall((:GRBsetcallbackfuncadv, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cvoid}, Ptr{Cvoid}, Cuint), model, cb, usrdata, wheres)
end
...
function GRBsetcallbackfuncenvadv(env, cb, usrdata, wheres)
    ccall((:GRBsetcallbackfuncenvadv, libgurobi), Cint, (Ptr{GRBenv}, Ptr{Cvoid}, Ptr{Cvoid}, Cuint), env, cb, usrdata, wheres)
end
...
function GRBcbproceed(cbdata)
    ccall((:GRBcbproceed, libgurobi), Cint, (Ptr{Cvoid},), cbdata)
end
...
function GRBcbsetintparam(cbdata, paramname, newvalue)
    ccall((:GRBcbsetintparam, libgurobi), Cint, (Ptr{Cvoid}, Ptr{Cchar}, Cint), cbdata, paramname, newvalue)
end

function GRBcbsetdblparam(cbdata, paramname, newvalue)
    ccall((:GRBcbsetdblparam, libgurobi), Cint, (Ptr{Cvoid}, Ptr{Cchar}, Cdouble), cbdata, paramname, newvalue)
end

function GRBcbsetstrparam(cbdata, paramname, newvalue)
    ccall((:GRBcbsetstrparam, libgurobi), Cint, (Ptr{Cvoid}, Ptr{Cchar}, Ptr{Cchar}), cbdata, paramname, newvalue)
end
...
function GRBgetgenconstrNL(model, genconstr, resvarP, nnodesP, opcode, data, parent)
    ccall((:GRBgetgenconstrNL, libgurobi), Cint, (Ptr{GRBmodel}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}), model, genconstr, resvarP, nnodesP, opcode, data, parent)
end
...
function GRBcopymodeltoenv(model, env, resultP)
    ccall((:GRBcopymodeltoenv, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{GRBenv}, Ptr{Ptr{GRBmodel}}), model, env, resultP)
end
...
function GRBisgpusupported(env)
    ccall((:GRBisgpusupported, libgurobi), Cint, (Ptr{GRBenv},), env)
end

function GRBisgpubuild()
    ccall((:GRBisgpubuild, libgurobi), Cint, ())
end

function GRBemptyenvadvnocheck(envP, malloccb, calloccb, realloccb, freecb, threadcreatecb, threadjoincb, syscbusrdata)
    ccall((:GRBemptyenvadvnocheck, libgurobi), Cint, (Ptr{Ptr{GRBenv}}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), envP, malloccb, calloccb, realloccb, freecb, threadcreatecb, threadjoincb, syscbusrdata)
end
...
function GRBaddgenconstrNL(model, name, resvar, nnodes, opcode, data, parent)
    ccall((:GRBaddgenconstrNL, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cchar}, Cint, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}), model, name, resvar, nnodes, opcode, data, parent)
end
...
function GRBsingularvectors(model, left, right)
    ccall((:GRBsingularvectors, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cdouble}, Ptr{Cdouble}), model, left, right)
end
...
function GRBclean2checknan(lenP, ind, val)
    ccall((:GRBclean2checknan, libgurobi), Cint, (Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), lenP, ind, val)
end
...
function GRBclean3checknan(lenP, ind0, ind1, val)
    ccall((:GRBclean3checknan, libgurobi), Cint, (Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), lenP, ind0, ind1, val)
end

function GRBprintquality(model)
    ccall((:GRBprintquality, libgurobi), Cint, (Ptr{GRBmodel},), model)
end
...
function GRBreadconcurrentsettings(model, filename)
    ccall((:GRBreadconcurrentsettings, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cchar}), model, filename)
end

function GRBreadmultiobjsettings(model, filename)
    ccall((:GRBreadmultiobjsettings, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cchar}), model, filename)
end

function GRBreadtunebasesettings(env, filename)
    ccall((:GRBreadtunebasesettings, libgurobi), Cint, (Ptr{GRBenv}, Ptr{Cchar}), env, filename)
end

function GRBreadtuneignoresettings(env, filename)
    ccall((:GRBreadtuneignoresettings, libgurobi), Cint, (Ptr{GRBenv}, Ptr{Cchar}), env, filename)
end
...
function GRBloadenvadv(envP, logfilename, apitype, major, minor, tech, server, router, password, group, priority, idletimeout, cloudaccessid, cloudsecretkey, cb, usrdata, logcb, logdata)
    ccall((:GRBloadenvadv, libgurobi), Cint, (Ptr{Ptr{GRBenv}}, Ptr{Cchar}, Cint, Cint, Cint, Cint, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cchar}, Cint, Cint, Ptr{Cchar}, Ptr{Cchar}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}, Ptr{Cvoid}), envP, logfilename, apitype, major, minor, tech, server, router, password, group, priority, idletimeout, cloudaccessid, cloudsecretkey, cb, usrdata, logcb, logdata)
end
...
function GRBgetdistro(str)
    ccall((:GRBgetdistro, libgurobi), Cvoid, (Ptr{Cchar},), str)
end
...
function GRBgettuneresult(model, result)
    ccall((:GRBgettuneresult, libgurobi), Cint, (Ptr{GRBmodel}, Cint), model, result)
end

function GRBgettunelog(model, result, logP)
    ccall((:GRBgettunelog, libgurobi), Cint, (Ptr{GRBmodel}, Cint, Ptr{Ptr{Cchar}}), model, result, logP)
end

function GRBwritetunelog(model, result, filename)
    ccall((:GRBwritetunelog, libgurobi), Cint, (Ptr{GRBmodel}, Cint, Ptr{Cchar}), model, result, filename)
end

function GRBwritetuneparamsets(model, filename)
    ccall((:GRBwritetuneparamsets, libgurobi), Cint, (Ptr{GRBmodel}, Ptr{Cchar}), model, filename)
end

function GRBtuneparamsPrint()
    ccall((:GRBtuneparamsPrint, libgurobi), Cvoid, ())
end
...
const GRB_ERROR_GPU = 10033

const GRB_ERROR_OVERFLOW = 10034

const GRB_C_MAX_ERROR = 10034
...
const GRB_DBL_ATTR_POOLNOBJVAL = "PoolNObjVal"
...
const GRB_INT_ATTR_BARSTATUS = "BarStatus"

const GRB_INT_ATTR_BARITERCOUNT = "BarIterCount"

const GRB_INT_ATTR_NLBARITERCOUNT = "NLBarIterCount"

const GRB_DBL_ATTR_PDHGITERCOUNT = "PDHGIterCount"
...
const GRB_DBL_ATTR_POOLNX = "PoolNX"
...
const GRB_DBL_ATTR_POOL_MAX_VIO = "PoolNMaxVio"

const GRB_DBL_ATTR_POOL_BOUND_VIO = "PoolNBoundVio"

const GRB_INT_ATTR_POOL_BOUND_VIO_INDEX = "PoolNBoundVioIndex"

const GRB_DBL_ATTR_POOL_BOUND_VIO_SUM = "PoolNBoundVioSum"

const GRB_DBL_ATTR_POOL_CONSTR_VIO = "PoolNConstrVio"

const GRB_INT_ATTR_POOL_CONSTR_VIO_INDEX = "PoolNConstrVioIndex"

const GRB_DBL_ATTR_POOL_CONSTR_VIO_SUM = "PoolNConstrVioSum"

const GRB_DBL_ATTR_POOL_INT_VIO = "PoolNIntVio"

const GRB_INT_ATTR_POOL_INT_VIO_INDEX = "PoolNIntVioIndex"

const GRB_DBL_ATTR_POOL_INT_VIO_SUM = "PoolNIntVioSum"
...
const GRB_INT_ATTR_NUMOBJPASSES = "NumObjPasses"

const GRB_INT_ATTR_OBJNPASS = "ObjNPass"

const GRB_DBL_ATTR_OBJNPASSITERCOUNT = "ObjNPassIterCount"

const GRB_DBL_ATTR_OBJNPASSMIPGAP = "ObjNPassMIPGap"

const GRB_DBL_ATTR_OBJNPASSNODECOUNT = "ObjNPassNodeCount"

const GRB_DBL_ATTR_OBJNPASSOBJBOUND = "ObjNPassObjBound"

const GRB_DBL_ATTR_OBJNPASSOBJVAL = "ObjNPassObjVal"

const GRB_DBL_ATTR_OBJNPASSOPENNODECOUNT = "ObjNPassOpenNodeCount"

const GRB_DBL_ATTR_OBJNPASSRUNTIME = "ObjNPassRuntime"

const GRB_INT_ATTR_OBJNPASSSTATUS = "ObjNPassStatus"

const GRB_DBL_ATTR_OBJNPASSWORK = "ObjNPassWork"
...
const GRB_OPCODE_TANH = 18

const GRB_OPCODE_SIGNPOW = 19

const NUMOPCODETYPES = 20

const GRB_OPCODE_VCPOW = 20

const GRB_OPCODE_CVPOW = 21
...
const GRB_CB_PDHG = 10

const GRB_CB_NLBAR = 11
...
const GRB_CB_PDHG_ITRCNT = 10001

const GRB_CB_PDHG_PRIMOBJ = 10002

const GRB_CB_PDHG_DUALOBJ = 10003

const GRB_CB_PDHG_PRIMINF = 10004

const GRB_CB_PDHG_DUALINF = 10005

const GRB_CB_PDHG_COMPL = 10006

const GRB_CB_NLBAR_ITRCNT = 11001

const GRB_CB_NLBAR_PRIMOBJ = 11002

const GRB_CB_NLBAR_PRIMINF = 11003

const GRB_CB_NLBAR_DUALINF = 11004

const GRB_CB_NLBAR_COMPL = 11005
...
GRBemptyenvadv(envP, malloccb, callocbc, realloccb, freecb, threadcreatecb, threadjoincb, syscbusrdata) = GRBemptyenvadvinternal(envP, -1, GRB_VERSION_MAJOR, GRB_VERSION_MINOR, GRB_VERSION_TECHNICAL, malloccb, callocbc, realloccb, freecb, threadcreatecb, threadjoincb, syscbusrdata)
...
const GRB_LOCALLY_OPTIMAL = 18

const GRB_LOCALLY_INFEASIBLE = 19
...
const GRB_INT_PAR_NLBARITERLIMIT = "NLBarIterLimit"
...
const GRB_DBL_PAR_NLBARPFEASTOL = "NLBarPFeasTol"

const GRB_DBL_PAR_NLBARDFEASTOL = "NLBarDFeasTol"

const GRB_DBL_PAR_NLBARCFEASTOL = "NLBarCFeasTol"
...
const GRB_DBL_PAR_PDHGITERLIMIT = "PDHGIterLimit"

const GRB_DBL_PAR_PDHGRELTOL = "PDHGRelTol"

const GRB_DBL_PAR_PDHGABSTOL = "PDHGAbsTol"

const GRB_DBL_PAR_PDHGCONVTOL = "PDHGConvTol"

const GRB_INT_PAR_PDHGGPU = "PDHGGPU"
...
const GRB_INT_PAR_FIXVARSININDICATORS = "FixVarsInIndicators"
...
const GRB_DBL_PAR_IMPROVESTARTWORK = "ImproveStartWork"
...
const GRB_INT_PAR_NORELHEURSOLUTIONS = "NoRelHeurSolutions"
...
const GRB_DBL_PAR_STARTTIMELIMIT = "StartTimeLimit"

const GRB_DBL_PAR_STARTWORKLIMIT = "StartWorkLimit"
...
const GRB_INT_PAR_MASTERKNAPSACKCUTS = "MasterKnapsackCuts"
...
const GRB_INT_PAR_OPTIMALITYTARGET = "OptimalityTarget"
...
const GRB_INT_PAR_INHERITPARAMS = "InheritParams"
...
GRBloadenv(envP, logfilename) = GRBloadenvinternal(envP, logfilename, GRB_VERSION_MAJOR, GRB_VERSION_MINOR, GRB_VERSION_TECHNICAL)

GRBemptyenv(envP) = GRBemptyenvinternal(envP, GRB_VERSION_MAJOR, GRB_VERSION_MINOR, GRB_VERSION_TECHNICAL)
